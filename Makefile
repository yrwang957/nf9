...
main: main.o nf9headers.o udp.o buf_list.o templ_tbl.o
	${CC} main.o nf9headers.o udp.o buf_list.o templ_tbl.o ${CFLAGS} ${INC} ${LIB} -o nf9

main.o: main.c
	${CC} main.c ${CFLAGS} ${INC} ${LIB} -c

nf9r.o: nf9headers.c
	${CC} nf9headers.c ${CFLAGS} ${INC} ${LIB} -c
